...
- The SDK uses hardened JSON parsing in its raw Webhook and OSB parsing paths. It removes `__proto__`, `constructor`, and `prototype` keys from the parsed payload; continue to verify signatures and validate payloads before fulfillment.
